    ...
    public static void main(String[] args) throws IOException {
     ...
     System.out.println(spisok.getRandomizeList().size());*/
        ...
        while ( -1 != (code = System.in.read()) )
        {
               ...
               if ('v' == ch)
               {
                   System.out.print("Список тех, кто не задавал вопрос: ");      System.out.println(spisok.getRandomizeListV().size());
               ...
               if ('o' == ch)
                {
                    System.out.print("Список тех, кто не отвечал: "); System.out.println(spisok.getRandomizeListO().size());
